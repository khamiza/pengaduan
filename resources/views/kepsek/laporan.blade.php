...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <form method="GET" action="{{ url('/kepsek/laporan') }}" class="row mb-4">
            <div class="col-md-3">
                <label>Search</label>
            ...
            <div class="col-md-3 d-flex align-items-end">
                ...
                <a href="{{ url('/kepsek/laporan') }}" class="btn btn-secondary mr-2">Reset</a>
                <a href="{{ url('/kepsek/laporan/pdf') }}?search={{ request('search') }}&dari={{ request('dari') }}&sampai={{ request('sampai') }}" class="btn btn-danger" target="_blank">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            @if($item->status=='menunggu') <span class="badge bg-warning text-dark">Menunggu</span>
                            @elseif($item->status=='proses') <span class="badge bg-primary">Proses</span>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <hr>
                                    <p><strong>Aspirasi Lengkap:</strong> {{ $item->inputAspirasi->keterangan ?? '-' }}</p>
                                    <hr>
